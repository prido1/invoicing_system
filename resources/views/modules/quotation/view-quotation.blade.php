                ...
                <div class="container">
                    <div class="row">
                        <div class="box-tools py-1">
                            <a href="/quotation/edit/{{ $quotation->id }}">
                            ...
                            <a href="/quotation/print/{{ $quotation->id }}" target="_blank"
                                    ...
                                    <table class="table table-bordered">
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%" class="table-amount text-right">
                                                    {{ number_format($quotation->vat, 2) }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="table-amount text-right">{{ number_format(($quotation->vat / 100 + 1) * ( $total_price - $quotation->discount), 2) }}
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
    ...
    <div class="modal fade" id="sendEmail" tabindex="-1" role="dialog" aria-labelledby="add client" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="/quotation/send" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="add-client-form">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $quotation->client?->email }}" type="text" class="form-control"
                            ...
                            <div class="form-check">
                                <input name="attach" checked type="checkbox" class="form-check-input" id="exampleCheck1">
    ...
    <script>
        ...
        function choose_template(e) {
           ...
           spinner.removeClass('d-none');
            ...
            var url = "/etemplate/template/quotation"
            $.ajax({
                    url: url,
                    type: 'post',
